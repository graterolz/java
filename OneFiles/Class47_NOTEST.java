...
public class Class47 {
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		BufferedImage image = ImageIO.read(new URL("http://people.mozilla.com/~faaborg/files/20090526-firefoxIteration8/shiretokoFirefoxIcon-i8.png_large.png"));
...
class ImageView extends JComponent {
	...
	//
	void ImageView(final BufferedImage image, final AffineTransform xfrm) {
